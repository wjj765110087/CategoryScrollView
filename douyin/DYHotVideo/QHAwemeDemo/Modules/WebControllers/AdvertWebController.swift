...
/// 支付网页
class AdvertWebController: QHBaseViewController {
    
    private lazy var navBar: QHNavigationBar = {
        let bar = QHNavigationBar()
        bar.backgroundColor = UIColor(r: 16, g: 13, b: 32)
...
extension AdvertWebController:  QHNavigationBarDelegate  {
...
extension AdvertWebController: WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        showServerWarningAlert(msg: "支付成功后，10分钟之内\r即可到账，如未到账，\r请前往交流群，或消息-意见反馈，\r与我们联系，带来不便敬请谅解")
    }
