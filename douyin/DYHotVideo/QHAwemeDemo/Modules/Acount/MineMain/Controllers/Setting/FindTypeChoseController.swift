...
class FindTypeChoseController: UIViewController {
    ...
    private lazy var idCardBtn: UIButton = {
        ...
        button.setBackgroundImage(UIImage.imageFromColor(UIColor(red: 56/255.0, green: 59/255.0, blue: 71/255.0, alpha: 0.99), frame: CGRect(x: 0, y: 0, width: ConstValue.kScreenWdith - 20, height: 60)), for: .normal)
        button.setBackgroundImage(UIImage.imageFromColor(ConstValue.kVcViewColor, frame: CGRect(x: 0, y: 0, width: ConstValue.kScreenWdith - 20, height: 60)), for: .highlighted)
...
//    }()
    ...
    private lazy var cancleBtn: UIButton = {
        ...
        button.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        button.setBackgroundImage(UIImage.imageFromColor(UIColor(red: 56/255.0, green: 59/255.0, blue: 71/255.0, alpha: 0.99), frame: CGRect(x: 0, y: 0, width: ConstValue.kScreenWdith - 20, height: 50)), for: .normal)
        button.setBackgroundImage(UIImage.imageFromColor(ConstValue.kVcViewColor, frame: CGRect(x: 0, y: 0, width: ConstValue.kScreenWdith - 20, height: 50)), for: .highlighted)
        button.setTitleColor(UIColor.white, for: .normal)
...
private extension FindTypeChoseController {
    ...
    func layoutButtons() {
        ...
        infoBtn.snp.makeConstraints { (make) in
            ...
            make.height.equalTo(55)
            make.bottom.equalTo(callUsBtn.snp.top).offset(-5)
        }
        idCardBtn.snp.makeConstraints { (make) in
            make.leading.trailing.equalTo(callUsBtn)
            make.height.equalTo(55)
            make.bottom.equalTo(infoBtn.snp.top).offset(-5)
        }
//        idCardBtn.snp.makeConstraints { (make) in
//            make.leading.trailing.equalTo(callUsBtn)
//            make.height.equalTo(55)
//            make.bottom.equalTo(phoneBtn.snp.top).offset(-5)
//        }
    }
