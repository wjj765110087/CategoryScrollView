...
class InfoFindAcountController: UIViewController {
    ...
    private lazy var orderNumTf: UITextField = {
        ...
        textFiled.setPlaceholderTextColor(placeholderText: "  请填写订单编号", color: UIColor(white: 0.7, alpha: 0.6))
        return textFiled
    }()
    /// username
    ...
    private lazy var usernameTf: UITextField = {
        ...
        textFiled.setPlaceholderTextColor(placeholderText: "  如:郑成仁", color: UIColor(white: 0.7, alpha: 0.6))
        return textFiled
    }()
    /// 注册时间
    ...
    private lazy var registerTimeTf: UITextField = {
        ...
        textFiled.setPlaceholderTextColor(placeholderText: "  如：GZDKZ", color: UIColor(white: 0.7, alpha: 0.6))
        return textFiled
    }()
    ///  说明备注
    ...
    lazy var remarkTextView: UITextView = {
        ...
        textView.backgroundColor = UIColor(red: 51/255.0  , green: 54/255.0, blue: 69/255.0, alpha: 0.99)
...
extension InfoFindAcountController:  QHNavigationBarDelegate  {
