//
//  CommunityTopicController.swift
//  QHAwemeDemo
//
...
class CommunityTopicController: QHBaseViewController {
    
    private lazy var navBar: QHNavigationBar = {
        let bar = QHNavigationBar()
        bar.titleLabel.text = "话题圈"
    ...
    private lazy var controllers: [UIViewController] = {
        let oneVc = CommunityRecommandController()
        let twoVc = CommunityAttentionController()
        return [oneVc, twoVc]
    }()
...
//MARK: -设置UI && Layout
extension CommunityTopicController {
...
extension CommunityTopicController: QHNavigationBarDelegate  {
    func backAction() {
