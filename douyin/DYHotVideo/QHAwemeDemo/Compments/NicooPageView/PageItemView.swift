...
extension PageItemView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if  titles[indexPath.item] == "原创" {
            cell.itemBtn.setImage(UIImage(named: "DIY"), for: .normal)
            cell.itemBtn.setImage(UIImage(named: "DIY"), for: .selected)
            cell.itemBtn.setTitle("", for: .normal)
            cell.itemBtn.setTitleColor(UIColor.darkText, for: .normal)
            cell.itemBtn.setTitleColor(UIColor.darkText, for: .selected)
        } else {
            cell.itemBtn.setImage(nil, for: .normal)
            cell.itemBtn.setImage(nil, for: .selected)
            cell.itemBtn.setTitleColor(UIColor.white, for: .normal)
            cell.itemBtn.setTitleColor(UIColor.white, for: .selected)
        }
