...
open class  ScanWrapper: NSObject,AVCaptureMetadataOutputObjectsDelegate {
    ...
    /**
     ...
     - returns:
     */
    init( videoPreView:UIView,objType:[AVMetadataObject.ObjectType] = [(AVMetadataObject.ObjectType.qr as NSString) as AVMetadataObject.ObjectType],isCaptureImg:Bool,cropRect:CGRect=CGRect.zero,success:@escaping ( ([ ScanResult]) -> Void) )
    {
        do{
    ...
    /**
     ...
     - returns: 返回识别结果
     */
    static public func recognizeQRImage(image:UIImage) ->[ ScanResult]
    {
    ...
    //获取二维码的图像区域
    static public func getConcreteCodeRectFromImage(srcCodeImage:UIImage,codeResult: ScanResult)->CGRect
    {
