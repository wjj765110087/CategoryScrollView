...
class HelpController: UIViewController {
    ...
    private lazy var bgScroll: UIView = {
        let scroll = UIView.init(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 710))
    ...
    private lazy var textContainer: UIView = {
        let view = UIView.init(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 240))
    ...
    private let detailExLab: UILabel = {
        ...
        label.textColor = UIColor(r: 255, g: 42, b: 49)
    ...
    private lazy var photoView: PhotoChoseView = {
        let view = PhotoChoseView.init(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 100))
    ...
    lazy var commitBtn: UIButton = {
        let button = UIButton(type: .custom)
        button.backgroundColor = kAppDefaultTitleColor
        button.layer.cornerRadius = 22.5
        button.layer.masksToBounds = true
        button.layer.shadowColor = UIColor(r: 244, g: 244, b: 244).cgColor
    ...
    private func setUpUI() {
        ...
        connectTf.setValue(UIColor(white: 0.7, alpha: 0.6), forKeyPath: "_placeholderLabel.textColor")
    }
    ...
    private func addItemView() {
        ...
        //封装的view
        recordView = ItemLayoutView(aFrame: CGRect(x: 0, y: 0, width: screenWidth, height: 120), aTitle: "请选择反馈问题", aArray: items)
    ...
    private func addViewModelCallBackHandler() {
        viewMode.fadeBackSuccessHandler = { [weak self] in
            ...
            strongSelf.showDialog(title: nil, message: "反馈成功，感谢您的建议！", okTitle: nil, cancelTitle: "知道了", okHandler: nil, cancelHandler: {
    ...
    @objc private func commitClick() {
      ...
      // 这里先吊用图片上传，不管上传成功失败，都吊用提交
        ...
        if photoView.pictures.count > 0 {
            ...
            for image in photoView.pictures {
...
extension HelpController:  CNavigationBarDelegate  {
...
private extension HelpController {
    ...
    func layoutScrollSubviews() {
        detailExLab.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(recordView!.snp.bottom).offset(15)
        ...
        textContainer.snp.makeConstraints { (make) in
            make.leading.equalTo(15)
            make.top.equalTo(detailExBtn.snp.bottom).offset(15)
            make.trailing.equalTo(-15)
