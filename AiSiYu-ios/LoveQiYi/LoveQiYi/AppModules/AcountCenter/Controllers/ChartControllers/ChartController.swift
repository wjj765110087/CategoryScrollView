...
class ChartController: BaseController {
    ...
    private func showPhotoBrowser(_ pictures:[String], _ index: Int) {
        if index > pictures.count - 1 { return }
        let bo = PhotoBrowserController()
        bo.imageUrlSource = pictures //["http://images.china.cn/attachement/jpg/site1000/20140910/001ec9591e621579f4bc06.jpg","http://s6.sinaimg.cn/mw690/002JP5eOgy6IS2UThFb45&690", "http://img1.gtimg.com/ent/pics/hv1/21/57/1675/108931431.jpg"]
        bo.currentIndex = index
        self.present(bo, animated: false, completion: nil)
    }
