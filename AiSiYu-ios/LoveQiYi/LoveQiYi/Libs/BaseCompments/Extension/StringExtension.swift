...
public extension String {
    ...
    static func dicValueToString(_ dic:[String: Any]) -> String? {
    ...
    static func stringValueToDic(_ str:String) -> [String: Any]? {
...
open class TextSpaceManager: NSObject {
    ...
    open class func configColorString(allString: String, attribStr: String, _ attColor: UIColor? = UIColor(r: 255, g: 42, b: 49), _ fontSize: UIFont? = UIFont.systemFont(ofSize: 17)) -> NSAttributedString? {
        let attribute = [NSAttributedString.Key.foregroundColor : attColor, NSAttributedString.Key.font : fontSize]
