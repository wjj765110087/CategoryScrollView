...
class SystemAlert: UIView {
    ...
    private let customLayout: CustomFlowPhotoLayout = {
        ...
        layout.itemSize = CGSize(width: 240, height: 210)
        // layout.
        return layout
    }()
    lazy var collectionView: UICollectionView = {
        let collection = UICollectionView(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 150), collectionViewLayout: customLayout)
...
extension SystemAlert: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.textView.text = messages[indexPath.row].msg
