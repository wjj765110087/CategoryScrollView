...
class SwiftAdView: UIViewController {
    ...
    private lazy var adTimerBtn: UIButton = {
        ...
        btn.setTitle("\(Int(adTime))S", for: .normal)
...
//            if self.adTime == 0.0 {
            if self.adTimerBtn.titleLabel?.text == "进入" {
                self.view.alpha = 0.2
