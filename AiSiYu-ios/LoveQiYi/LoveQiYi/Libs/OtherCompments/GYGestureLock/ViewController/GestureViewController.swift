...
class GestureViewController: UIViewController {
    ...
    func setupSubViewsLoginVc() {
        ...
        imageView.center = CGPoint(x: kScreenW/2, y: self.msgLabel!.frame.minY - imageView.bounds.height/2 - 20)
        imageView.image = UserModel.share().getUserHeader()
...
//
//        creatButton(rightBtn, frame: CGRect(x: kScreenW/2 - CircleViewEdgeMargin - 20, y: kScreenH - 60, width: kScreenW/2, height: 20), titlr: "登录其他账户", alignment: .right, tag: buttonTag.forget.rawValue)
...
extension GestureViewController: CNavigationBarDelegate  {
