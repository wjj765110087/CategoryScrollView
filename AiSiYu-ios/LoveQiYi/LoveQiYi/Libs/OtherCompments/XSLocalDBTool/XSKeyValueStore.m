...
@interface XSKeyValueStore()

@property (strong, nonatomic) FMDatabaseQueue * dbQueue;

@end

@implementation XSKeyValueStore
...
- (void)createTableWithName:(NSString *)tableName {
    if ([XSKeyValueStore checkTableName:tableName] == NO) {
        return;
    }
...
- (id)getObjectById:(NSString *)objectId fromTable:(NSString *)tableName {
    XSKeyValueItem * item = [self getKeyValueItemById:objectId fromTable:tableName];
    if (item) {
...
- (XSKeyValueItem *)getKeyValueItemById:(NSString *)objectId fromTable:(NSString *)tableName {
    if ([XSKeyValueStore checkTableName:tableName] == NO) {
        return nil;
    }
    ...
    if (json) {
        ...
        XSKeyValueItem * item = [[XSKeyValueItem alloc] init];
...
- (NSArray *)getAllItemsFromTable:(NSString *)tableName {
    ...
    NSError * error;
    for (XSKeyValueItem * item in result) {
        error = nil;
